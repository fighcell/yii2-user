...
```php
class User extends \fighcell\user\models\User
{
...
You should override view file `@fighcell/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
...
```php
class RegistrationForm extends \fighcell\user\models\RegistrationForm
{
    /**
     * @var string
     */
