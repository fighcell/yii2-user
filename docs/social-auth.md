...
```php
'facebook' => [
    'class'        => 'fighcell\user\clients\Facebook',
    'clientId'     => 'APP_ID',
...
```php
'twitter' => [
    'class'          => 'fighcell\user\clients\Twitter',
...
```php
'google' => [
    'class'        => 'fighcell\user\clients\Google',
    'clientId'     => 'CLIENT_ID',
...
```php
'github' => [
    'class'        => 'fighcell\user\clients\GitHub',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
],
```
...
```php
'vkontakte' => [
    'class'        => 'fighcell\user\clients\VKontakte',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
]
```
...
```php
'yandex' => [
    'class'        => 'fighcell\user\clients\Yandex',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
```php
'linkedin' => [
    'class'        => 'fighcell\user\clients\LinkedIn',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
use fighcell\user\controllers\SecurityController; 
