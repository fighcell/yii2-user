...
class AdminController extends Controller
{
     ...
     * Triggered with \fighcell\user\events\UserEvent.
     */
    ...
    /**
     * If "fighcell/yii2-rbac" extension is installed, this page displays form
    ...
    {
        if (!isset(\Yii::$app->extensions['fighcell/yii2-rbac'])) {
